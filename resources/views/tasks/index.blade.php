                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{{ $task->name }}</td>
                                <td>
                                    <a href="{{ route('tasks.index', ['edit' => $task->id]) }}" class="btn btn-sm btn-primary"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
